...
public class TransitController {
    ...
    public String getNearbyBuses(BusRequest request, Model model) {
        ...
        Location personLoc = apiService.getCoordinates(request.getAddress()+"+"+request.getCity());
        System.out.println(personLoc.lat);
        System.out.println(personLoc.lng);
        model.addAttribute("buses", buses);
        model.addAttribute("request", request);  
        model.addAttribute("personLoc", personLoc);
        return "index";
    }
}